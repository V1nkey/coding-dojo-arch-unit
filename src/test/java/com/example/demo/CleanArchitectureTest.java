...
public class CleanArchitectureTest {
    ...
    @Test
    public void usecase_should_have_only_one_public_method_which_should_be_called_execute() {
        JavaClasses classes =
        ...
        ArchRule rule =
                ArchRuleDefinition.classes()
                        ...
                        .should(
                                new ArchCondition<>("have only one public method") {
                                    @Override
                                    public void check(
                                        ...
                                        conditionEvents.add(
                                                new SimpleConditionEvent(
                                                        ...
                                                        conditionSatisfied,
                                                        String.format(
                                                                "The class %s have more than one public method",
                                                                javaClass.getName())));
                                    }
                                })
                        .andShould(
                                new ArchCondition<>("have a public method called execute") {
                                    @Override
                                    public void check(
                                            JavaClass javaClass, ConditionEvents conditionEvents) {
                                        boolean conditionSatisfied =
                                        ...
                                        conditionEvents.add(
                                                new SimpleConditionEvent(
                                                        ...
                                                        conditionSatisfied,
                                                        String.format(
                                                                "The class %s doesn't have a public method not called execute",
                                                                javaClass.getName())));
                                    }
                                });
    ...
    public void classes_implementing_a_port_should_be_suffixed_by_Adapter() {
        ...
        DescribedPredicate<JavaClass> implementsAPort =
                new DescribedPredicate<>("implements an interface suffixed by Port") {
                    @Override
